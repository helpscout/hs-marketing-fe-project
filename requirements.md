...
1. Build out the page to match the provided design in Figma (link!)
...
1. The callout near the footer (with trial buttom) should leverage the GetStartedCallout component.
